...
FROM docker.io/gitea/runner:3.3.1-dind AS gitea-runner-dind
FROM ghcr.io/linuxserver/mods:universal-docker-in-docker-29.7.2-5.5.0 AS docker-in-docker-mod
